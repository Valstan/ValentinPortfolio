      ...
      <section className="wrap section">
        <div className="section__head">
          ...
          <p className="section__lede">
            ...
            схемы устройства. Форм, собирающих ваши данные, здесь нет и не будет: у сайта нет
            сервера, отправлять их некуда. Посещаемость с 22.08.2026 считает Яндекс.Метрика — она
            ставит свои cookie, и её цифру видно внизу любой страницы: статистика этого сайта
            открыта всем, а не только мне.
          </p>
        </div>
        <div className="hero__actions">
