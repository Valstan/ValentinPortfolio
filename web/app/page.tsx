...
const COUNTERS = [
  ...
  // «128 страниц перенесено за день» отсюда убрано 04.09: единственным доказательством
  // была работа, снятая с витрины, а 14.09 удалённая из каталога совсем. Первый экран
  // обещает «каждое можно проверить по ссылке ниже», и число без открытой ссылки это
  // обещание нарушало. Утверждение живёт в разборе задачи о переносе как замер автора.
    ...
    <>
      <section className="wrap hero">
        ...
        <div className="hero__actions">
          ...
          <a href="/tehzadanie/" className="btn btn--ghost">
      ...
      <section className="wrap section">
        <div className="section__head">
          ...
          <p className="section__lede">
            ...
            ставит свои cookie и на всех страницах, кроме конструктора техзадания, может
            записывать действия посетителя (Вебвизор). Число посетителей видно внизу любой
            страницы, не только мне в кабинете.
          </p>
        </div>
        <div className="hero__actions">
