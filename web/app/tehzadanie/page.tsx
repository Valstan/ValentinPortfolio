    ...
    <>
      ...
      <section className="wrap section">
        ...
        <p className="note note--plain">
          Ничего не отправляется. У сайта нет сервера: документ собирает ваш браузер, и он же
          хранит ответы — в адресной строке. Поэтому ссылку можно отправить коллеге, и он увидит
          тот же черновик. По той же причине единственное, чего здесь нет, — поля для свободного
          текста «своими словами»: он попал бы в ссылку вместе со всем, что вы писали для себя.
          Своими словами допишете уже в готовом документе.
        </p>
        <p className="note note--plain">
