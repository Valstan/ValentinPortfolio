    ...
    <>
      ...
      <section className="wrap section section--flush">
        ...
        <div className="prose" style={{ marginTop: 40 }}>
          ...
          <p>
            Если писать с нуля не хочется — <Link href="/tehzadanie/">соберите черновик
            техзадания</Link>: те же вопросы по шагам, на выходе готовый текст, который можно
            вставить в сообщение или распечатать. Ответы считает ваш браузер, мне ничего не
            отправляется.
          </p>
          <ul>
